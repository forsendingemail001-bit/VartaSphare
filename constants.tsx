...
export const MOCK_DIRECTORY_GROUPS = [
  { id: 'gid_pubg_pro', name: 'PUBG Pro League', description: 'Competitive squad for chicken dinners.', icon: '🍗' },
  { id: 'gid_cod_war', name: 'COD Warzone', description: 'Daily deployments and tactical comms.', icon: '🔫' },
  { id: 'gid_tech_insiders', name: 'Tech Insiders', description: 'Leaks and hardware discussion.', icon: '💻' },
  { id: 'gid_crypto_pulse', name: 'Crypto Pulse', description: 'Market trends and analysis.', icon: '📈' }
];

export const MOCK_GLOBAL_ROOMS: any[] = [
  { id: 'gid_global_pubg', name: 'PUBG Global', description: 'Battle Royale chatter and squad finding.', type: 'global', members: [], icon: '🔥' },
  { id: 'gid_global_tech', name: 'Future Tech', description: 'Latest in AI, hardware, and space.', type: 'global', members: [], icon: '🚀' },
  { id: 'gid_global_music', name: 'Lo-fi Beats', description: 'Chilled music sharing and discussion.', type: 'global', members: [], icon: '🎵' },
];

// Added MOCK_CLANS to resolve the import error in GlobalHub.tsx
export const MOCK_CLANS = [
  { id: 'clan_1', name: 'Nebula Knights', tag: 'NEB', leaderId: 'uid_1', membersCount: 156, level: 42, banner: 'https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&q=80&w=1000' },
  { id: 'clan_2', name: 'Cyber Phantoms', tag: 'PHM', leaderId: 'uid_neo', membersCount: 89, level: 28, banner: 'https://images.unsplash.com/photo-1605810230434-7631ac76ec81?auto=format&fit=crop&q=80&w=1000' },
  { id: 'clan_3', name: 'Apex Predator', tag: 'APX', leaderId: 'uid_ghost', membersCount: 234, level: 55, banner: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&q=80&w=1000' }
];

export const Icons = {
  // Explicitly typing the component props to resolve "className does not exist on type IntrinsicAttributes" in App.tsx
  Logo: (props: { className?: string }) => {
    ...
    return (
      <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M32 35 L50 72 L68 35" stroke="white" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" filter="url(#logoGlow)" />
        <circle cx="50" cy="50" r="48" stroke="#3b82f6" strokeWidth="1" strokeDasharray="15 20" className="animate-[spin_4s_linear_infinite]" />
      </svg>
    );
  },
  ...
  Database: () => <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 21 19V5"/><path d="M3 12A9 3 0 0 0 21 12"/></svg>,
  ...
  Paint: () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19 7-7 3 3-7 7-3-3z"/><path d="m18 13-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="m2 2 5 5"/><path d="m5.2 9.6 3.2 3.2"/></svg>,
};
